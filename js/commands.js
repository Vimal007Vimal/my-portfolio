...
PROJECTS = [
  ...
  "developers. this portfilio have both GUI and CL",
  "- HTML",
  "- CSS",
  "- JS",
  "<a href=https://github.com/Vimal007Vimal> GitHub link",
  "<br>",
  "<strong> - LINUX Activitys.. <strong>",
  "This repository contains a Bash script designed to streamline",
  "configuration tasks on CentOS 7 systems. If you have any",
  "doubts refer my blog given bellow",
  "- DHCP",
  "- NFS",
  "- Mail server",
  "- FTP",
